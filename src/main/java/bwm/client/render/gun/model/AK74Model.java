 ...
 */
public class AK74Model implements IOverrideModel{
	...
	public void render(float partialTicks, TransformType transformType, ItemStack stack, ItemStack parent, LivingEntity entity, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int light, int overlay) {
		...
		RenderUtil.renderModel(SpecialModels.AK74BASE.getModel(), stack, matrixStack, renderTypeBuffer, light, overlay);
		RenderUtil.renderModel(SpecialModels.AK74MAGAZINE.getModel(), stack, matrixStack, renderTypeBuffer, light, overlay);
		...
		if(entity.equals(Minecraft.getInstance().player)) {
		    ...
		    RenderUtil.renderModel(SpecialModels.AK74BOLT.getModel(), stack, matrixStack, renderTypeBuffer, light, overlay);
		    //Always pop
		    matrixStack.pop();
